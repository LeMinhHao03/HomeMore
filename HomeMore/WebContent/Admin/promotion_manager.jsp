...
<title>Quản Lý Khuyến Mãi | Admin Home&More</title>
					...
					<div class="col-md-12">
						...
						<div class="btn btn-success" style="padding: 0px 0px;" >
							<button type="button" class="navbar-toggle"
								...
								<a class="navbar-brand" href="/HomeMore/Admin/muasukien_insert.jsp" style="color: white;text-transform:uppercase;font-size:14px;"> Thêm đợt khuyến mãi</a>
						</div>
					</div>
				</div>
				<hr />
									...
									<table class="table table-striped table-bordered table-hover"
										...
										<%
											...
											<tr class="odd gradeX">
												...
												<a href="/HomeMore/PromotionServlet_View?action=Views&ID_Promotion=<%=pr.getID_Promotion()%>"
