...
<title>Kích hoạt seri sản phẩm | Admin Home&More</title>
					...
					<div class="col-md-12">
						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<div class="row">
									<div class="col-md-6">
										<form action="/HomeMore/UpdateSeri" method="post">
											...
											<a href="/HomeMore/Admin/qlyseri.jsp"  class="btn btn-danger" style="margin-left:5%">Thoát</a>	
										</form>
										<br />
									</div>
								</div>
