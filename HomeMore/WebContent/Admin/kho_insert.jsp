...
<title>Quản Lý Kho Sản Phẩm | Admin Home&More</title>
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="panel panel-default">
							<div class="panel-heading" style="font-weight:bold; background:#428bca;color:white">Thêm Sản Phẩm Vào Kho</div>
							<div class="panel-body">
								<div class="row">
									<div class="col-md-6">
										<form role="form" action="/HomeMore/ProductServlet_Add_Del" method="post">
										    ...
										    <a href="qlykho.jsp"  class="btn btn-danger" style="margin-left:5%">Thoát</a>
										</form>
										<br />
									</div>
								</div>
