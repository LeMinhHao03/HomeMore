...
<title>Quản Lý Sản Phẩm | Admin Home&More</title>
				...
				<div class="row">
					<div class="col-md-12">
						...
						<!-- <div class="navbar-header">
							...
							<a class="navbar-brand" href="/HomeMore/Admin/product_insert.jsp" style="color: white;">Thêm Sản Phẩm</a>
					...
					<!-- 	<div class="btn btn-success" style="padding: 0px 0px;" >
							<button type="button" class="navbar-toggle"
								...
								<a class="navbar-brand" href="/HomeMore/Admin/product_insert.jsp" style="color: white;text-transform:uppercase;font-size:14px;"> Thêm Sản Phẩm</a>
						</div> -->
									...
									<table class="table table-striped table-bordered table-hover"
										...
										<%
											...
											<tr class="odd gradeX">
												...
												%>  href="/HomeMore/ProductServlet_Delete?action=Delete&ID_Product=<%=pro.getID_Product()%>" onclick="return confirm('Bạn có chắc chắn xóa sản phẩm <%=pro.getName_Product() %> không ?')"
