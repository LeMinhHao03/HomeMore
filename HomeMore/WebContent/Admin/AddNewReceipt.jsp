...
<title>Phiếu Nhập | Admin Home&More</title>
...
if (session.getAttribute("memberSession") == null) {
	response.sendRedirect("/HomeMore/account.jsp");
		...
		String masanpham = "", madanhmuc = "", tensanpham = "", hinhanh = "", soluong = "", mota = "",gianhap="", giaban="", giamgia="", nhanhieu="", baohanh="",mua="";
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="panel panel-default">
							<div class="panel-heading" style="font-weight:bold; background:#219afc;color:white">Thêm Mới Sản Phẩm</div>
							<div class="panel-body">
								<div class="row">
									<div class="col-md-6">
										<form role="form" action="/HomeMore/ReceiptDetailServlet_AddNew" method="post">
										<div class="form-group">
										    ...
										    <a href="/HomeMore/Admin/qlysanpham.jsp"  class="btn btn-danger" style="margin-left:5%">Thoát</a>
										</form>
										<br />
									</div>
								</div>
