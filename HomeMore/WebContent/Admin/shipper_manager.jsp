...
<title>Quản Lý Shipper| Admin Home&More</title>
<!-- BOOTSTRAP STYLES-->
				...
				<div class="row">
					<div class="col-md-12">
						...
						<!-- <div class="navbar-header">
							...
							<a class="navbar-brand" href="/HomeMore/Admin/shipper_insert.jsp" style="color: white;">Thêm shipper</a>
						</div> -->
						<div class="btn btn-success" style="padding: 0px 0px;" >
							<button type="button" class="navbar-toggle"
								...
								<a class="navbar-brand" href="/HomeMore/Admin/shipper_insert.jsp" style="color: white;text-transform:uppercase;font-size:14px;"> Thêm shipper</a>
						</div>
					</div>
				</div>
				<hr />
										...
										<%
											...
											<tr class="odd gradeX">
												...
												<td style="text-align:center"><%=s.getCompany_Shipper()%></td>
												 ...
												 <td class="center" style="text-align:center"><a href="/HomeMore/Admin/shipper_edit.jsp?action=Update&ID_Shipper=<%=s.getID_Shipper()%>&Name_Shipper=<%=s.getName_Shipper()%>&Phone_Shipper=<%=s.getPhone_Shipper()%>&Company_Shipper=<%=s.getCompany_Shipper()%>"
												...
												%>  href="/HomeMore/ShipperServlet_Delete?action=Delete&ID_Shipper=<%=s.getID_Shipper()%>" onclick="return confirm('Bạn có chắc chắn xóa shipper <%=s.getName_Shipper() %> không ?')"
