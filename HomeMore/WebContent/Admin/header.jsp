...
%>
	<div id="wrapper">
		...
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="/HomeMore/Admin/index.jsp">HOMEMORE</a>
		</div>
		<div
			style="color: white; padding: 15px 50px 5px 50px; float: right; font-size: 16px;">
			<a href="/HomeMore/Admin/index.jsp" style="margin-right:5px" class="btn btn-danger square-btn-adjust"><i style="font-size:20px"
					class="fa fa-home fa-3x" ></i></a>
			<a class="btn btn-danger square-btn-adjust" style="margin-right:5px">Tài khoản: <%=user.getUsername()%></a>
			<a href="/HomeMore/Admin/editprofileadmin.jsp" class="btn btn-danger square-btn-adjust" style="margin-right:5px">Cập nhật tài khoản</a>
			<a href="/HomeMore/LoginServlet?enter=logout" class="btn btn-danger square-btn-adjust">Đăng Xuất</a>
