			...
			<div class="panel-group category-products" id="accordian">
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<ul>
							<li><a
								href="index2.jsp?ID_Category=<%=danh_muc_con.getID_Category()%>"><%=danh_muc_con.getName_Category()%></a></li>
				...
				%>
					...
					<div class="panel-body">
						<ul>
							<li><a
								href="index2.jsp?ID_Brand=<%=nhan_hieu_con.getID_Brand()%>"><%=nhan_hieu_con.getName_Brand()%></a></li>
