...
<meta charset="UTF-8">
<title>Home&More | Bảo hành</title>
</head>
<body>
    <script>
	...
	<section style="margin-top: 0" id="page-content">
        ...
        <div class="container">
            ...
            <div class="center-content">
                <h3>TRUNG TÂM BẢO HÀNH Home&More</h3>
                <p>Tất cả trung tâm bảo hành ủy quyền Home&More trên toàn quốc đều được đào tạo và chỉ sử dụng linh kiện chính hãng Home&More trong mọi hoạt động sửa chữa.</p>
                ...
                <a data-toggle="collapse" href="#demo" role="button" aria-expanded="false" aria-controls="collapseExample">
                        >>> Chính sách bảo hành của Home&More
                </a>
            ...
            <div id="demo" class="bottom-content collapse">
                <h2>Chính sách bảo hành nhóm hàng gia dụng tại Home&More</h2>
    ...
    <div class="modal-dialog">
		          <form class="modal-content animate" >
		            ...
		            <div id="po1"  class="container-1">
		            	...
		            	<p style="text-align:center">Cảm ơn quý khách đã sử dụng sản phẩm của <span style="color:red">Home&More</span>.</p>
