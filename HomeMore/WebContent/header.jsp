   ...
   <script>
	$(document).ready(function(){
		$("#btnSearch").click(function(){
			...
			$.ajax({
				type: "post",
				url: "/HomeMore/searchServlet",
				data: {
					textSearch : textSearch
				},
				success : function(response){
					
						window.location.href="http://localhost:8080/HomeMore/index10.jsp"
				...
				<div class="col-sm-6">
					<div class="social-icons pull-right">
						<ul class="nav navbar-nav">
							<li><a target="_blank" href="https://www.facebook.com/profile.php?id=61552572301121" title="Facebook"><i
					...
					<div class="shop-menu pull-right">
						<ul class="nav navbar-nav">
							...
							<li><a <%if(user!=null){%> style="display:block; " <%}
									...
									<li><a 
										href="/HomeMore/profile.jsp">Thông tin tài khoản</a></li>
										<li><a 
										href="/HomeMore/invoiceDetail.jsp">Xem chi tiết đơn hàng</a></li>
										<li><a 
										href="/HomeMore/invoiceHistory.jsp">Xem lịch sử đơn hàng</a></li>
										<li>
		                            	<a href="/HomeMore/CheckBH.jsp">Bảo hành sản phẩm</a> 
	                        		</li>
										<li><a 
