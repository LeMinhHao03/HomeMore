...
<head>
<meta charset="UTF-8">
<title>Xem chi tiết đơn hàng | Home&More</title>
									...
									<table class="table table-striped table-bordered table-hover"
										...
										<tbody>
											<tr class="odd gradeX">
												...
												<a href="/HomeMore/InvoiceDetailServlet_Update_Del?action=Delete&ID_InvoiceDetail=<%=invoiceDetail.getID_InvoiceDetail() %>" onclick="return confirm('Bạn chắc chắn chứ ?')" class="btn btn-warning btn-xs">Hủy</a>
												</td>
											</tr>
										</tbody>
										<%
									...
									<table class="table table-striped table-bordered table-hover"
										...
										%>
											<tr class="odd gradeX">
												...
												<a href="/HomeMore/InvoiceHistoryDetail?action=Cancel&ID_Invoice=<%=invoice.getID_Invoice() %>"  onclick="return confirm('Bạn có muốn hủy đơn hàng này không ?')"
													<% 
													if (invoice.getStatus_Order()==3) {											
												...
												<a href="/HomeMore/InvoiceHistoryDetail?action=View&ID_Invoice=<%=invoice.getID_Invoice() %>"
