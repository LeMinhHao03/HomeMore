...
public class Mail {
	...
	public static String messageForgot(String email) {
		String urlString="http://localhost:8080/HomeMore/ForgotPassword.jsp?email="+email;
		String string = "<!DOCTYPE html>\r\n" + 
				...
				"    \r\n" + 
				"    <div>\r\n" + 
				"        <p>HOMEMORE XIN CHÀO! Vui lòng nhấn vào nút mật khẩu mới để thay đổi mật khẩu.</p>\r\n" + 
	 ...
	 public static boolean sendMail(String to, String subject, String message){
		 ...
		 try{
	         ...
	         String user = "haopb25@gmail.com";
	         String pass = "izcl lcjl auin uudj";
	         String from = "haopb25@gmail.com";
